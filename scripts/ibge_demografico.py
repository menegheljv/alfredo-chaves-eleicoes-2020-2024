...
fig.text(0.09, 0.955, "QUEM CONCORRE NÃO É QUEM VOTA", fontsize=15, color=INK, fontfamily="Anton", ha="left", va="top")
...
ax.set_ylim(0, 80)
fig.text(0.085, 0.955, "QUEM CONCORRE SE PARECE COM QUEM VIVE AQUI?", fontsize=14.5, color=INK, fontfamily="Anton", ha="left", va="top")
